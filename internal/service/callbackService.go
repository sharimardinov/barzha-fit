...
type CallbackService struct {
	...
	planView *PlanViewService
	stats    *StatsViewService
	tz       string
}

func NewCallbackService(workout *WorkoutService, nut *NutritionService, planView *PlanViewService, stats *StatsViewService, tz string) *CallbackService {
