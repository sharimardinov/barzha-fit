...
- сформировать программу из 6 упражнений
...
Формат каждого дня:
— первая строка: название дня (например: ГРУДЬ + БИЦЕПС (СИЛА + МАССА))
— далее блоки мышц и нумерованные упражнения с подходами/повторениями
