...
— затем выбрать подходящий шаблон: Fullbody, Upper/Lower, PPL, split
...
- Тяга горизонтального блока прямая ручка
...
- Приседания со штангой в смите
- Жим ногами высокая постановка стопы
...
- Отведение плеча в тренажере бабочка
- Отведение плеча на скамье с гантелями
...
- Разгибание предплечья из-за головы в кроссовере
- Жим лежа штанги узким хватом
- Поочередное разгибание предплечья в кроссовере
